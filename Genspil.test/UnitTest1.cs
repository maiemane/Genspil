...
// Vi benytter os af System.reflection til at ændre den statiske FilePath i GameInventory klassen, så vi kan teste uden at påvirke den originale fil.
// Vi benytter os af Xunit til at skrive vores tests.
// Vi benytter os af IDisposable interface til at rydde op efter os, når testen er færdig.

namespace Genspil.Tests


     
// For at teste, benytter vi os af AAA testing - Arrange, Act, Assert.
// Arrange: Sætter test-miljøet op, og forbereder diverse data som er nødvendigt for testing.
// Act: Udfører den handling vi ønsker at teste.
// Assert: Tjekker at resultatet er som forventet.
// Vi tester GameInventory klassen, som er ansvarlig for at håndtere spil i vores applikation.

{
    public class GameInventoryTests : IDisposable
    {
        ...
        {
            // Ændr den statiske FilePath i GameInventory til en testfil
            ...
            // Sørg for, at testfilen er tom før testkørslen
            if (File.Exists(TestFilePath))
                File.Delete(TestFilePath);
            File.WriteAllText(TestFilePath, "[]");

            // Opret en ny instans af GameInventory
        ...
        public void AddGame_ShouldAddNewGame()
        {
            ...
            // Assert: Tjek at spillet er tilføjet korrekt
        ...
        public void EditGame_ShouldChangeGameName()
        {
            ...
            // Assert: Spillets navn skal være ændret til "Skak"
            var games = inventory.GetGames();
            Assert.Single(games);
        ...
        public void Dispose()
        {
            // Ryd op: Slet testfilen efter kørsel
            if (File.Exists(TestFilePath))
                File.Delete(TestFilePath);
        }
    }
